...
let logger: Logger = Logger(subsystem: "in.amitsamant.skiptour", category: "SkipTour")
...
#if !SKIP
public protocol SkipTourApp : App {
}

/// The entry point to the SkipTour app.
/// The concrete implementation is in the SkipTourApp module.
public extension SkipTourApp {
    var body: some Scene {
        WindowGroup {
            RootView()
        }
